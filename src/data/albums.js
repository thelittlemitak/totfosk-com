...
const denki = {
  ...
  label: "Ki/oon (Sony)",
  decription:
    "Japanese music group founded in 1989. It consists of Takkyu Ishino and Pierre Taki (very active film and television actor)",
...
const modell = {
  ...
  label: "Tresor",
  decription:
    "Where Modell’s recent releases had indicated a priority for ambient sounds, this new album extends Modell’s essential vision within techno. He is also part of the well known duos Deepchord and Echospace. ",
  favorite: "X",
  albumCounting: "X",
...
const amelie = {
  ...
  favorite: "X",
  albumCounting: "X",
  genre: [genres.ost, genres.contemp, genres.folk, genres.piano].sort(),
  picID: 23237767,
  social: "X",
};
const estopa = {
...
const goreshit = {
  ...
  label: "Self-released",
  decription:
    "Leon Makepeace is an electronic artist known particularly for his contributions to the genre 'lolicore' a genre based on speedcore, mashcore and breakcore, but with samples of either high-pitched anime characters, typically what would be referred to 'lolis', or pitched samples of miscellaneous material.",
  favorite: "X",
  albumCounting: "X",
...
const erikB = {
  ...
  label: "X",
  decription:
    "The most influential DJ/MC combo in contemporary pop music period. The title track and 'Lyrics of Fury' were two of Rakim's most acclaimed lyrical performances.",
  favorite: "X",
  albumCounting: "X",
...
const eminem = {
  ...
  label: "AFTERMATH",
  decription:
    "Eminem: 'I'm cool with probably half that album. I recorded that towards the height of my addiction. I remember four songs leaked and I had to go to L.A. and get Dre and record new ones. I was in a room by myself writing songs in 25, 30 minutes because we had to get it done, and what came out was so goofy.'",
  favorite: "X",
  albumCounting: "X",
  genre: [genres.rap].sort(),
  picID: 8885555,
...
const kalk = {
  ...
  decription:
    "Kalkbrenner was approached by Hannes Stöhr, with the proposition of creating the soundtrack but then he chose him also to be the main star. The movie broke the record of longest run film in Germany (145 weeks in Kino Central Berlin).",
  favorite: "X",
  albumCounting: "X",
